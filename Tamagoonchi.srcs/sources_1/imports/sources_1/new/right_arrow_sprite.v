...
module right_arrow_sprite(
    ...
    localparam SCALE = 2;
    wire [4:0] sx = (x - X0) / SCALE; // MIRROR horizontally
    ...
    always @(*) begin
        case (sy)
            ...
            5'd5:  bitmap_FFFF = 24'h002000;
            5'd6:  bitmap_FFFF = 24'h003000;
            5'd7:  bitmap_FFFF = 24'h003800;
            5'd8:  bitmap_FFFF = 24'h003C00;
            5'd9:  bitmap_FFFF = 24'h003E00;
            5'd10:  bitmap_FFFF = 24'h003F00;
            5'd11:  bitmap_FFFF = 24'h003E00;
            5'd12:  bitmap_FFFF = 24'h003C00;
            5'd13:  bitmap_FFFF = 24'h003800;
            5'd14:  bitmap_FFFF = 24'h003000;
            5'd15:  bitmap_FFFF = 24'h002000;
